      ...
      <article className="max-w-4xl mx-auto px-4 py-12">
        ...
        {(event.attendees || event.price) && (
          <div className="grid grid-cols-2 gap-6 bg-slate-50 p-8 rounded-2xl mb-12 border border-slate-100">
            {event.price && (
              <div>
                <p className="text-[10px] text-slate-400 uppercase font-bold tracking-widest mb-2">Entry Fee</p>
                <p className="text-xl font-bold text-slate-900">{event.price}</p>
              </div>
            )}
            {event.attendees && (
              <div>
                <p className="text-[10px] text-slate-400 uppercase font-bold tracking-widest mb-2">Capacity / Attendees</p>
                <p className="text-xl font-bold text-slate-900">{event.attendees}</p>
              </div>
            )}
          </div>
        )}
